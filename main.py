...
if check_errors[1] > 0:
    ...
    print("da!  play the game ")

# Play Surface

PlaySurface = pygame.display.set_mode((720, 460))
pygame.display.set_caption(' Stick Snake Game ')
...
# Display my name like stick :
PlaySurface.fill(white)#game bacround
pfont = pygame.font.SysFont('monaco', 35)
pSurf = pfont.render('Welcome to Snake Game created by stick Team .', True, blue)#welcome panel
pRect = pSurf.get_rect()
pRect.midtop = (370, 200)
